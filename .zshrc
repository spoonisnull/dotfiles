...
POWERLEVEL9K_CUSTOM_K8SCTX="echo K8S: \$(kubectl config view | grep current | awk '{print \$2}' | cut -d'_' -f 2)"
POWERLEVEL9K_CUSTOM_K8SCTX_BACKGROUND='232'
POWERLEVEL9K_CUSTOM_K8SCTX_FOREGROUND='138'

POWERLEVEL9K_CUSTOM_GCPPROJ="echo GCP: \$(gcloud config list project 2>&1 | grep project | awk '{print \$3}')"
POWERLEVEL9K_CUSTOM_GCPPROJ_BACKGROUND='16'
POWERLEVEL9K_CUSTOM_GCPPROJ_FOREGROUND='138'

POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir ssh dir_writable status custom_first)
